    ...
    <GuestPage>
      ...
      <section className="py-10">
        <div className="container grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="section-frame dark-panel relative min-h-96 overflow-hidden">
            ...
            <div className="relative flex min-h-96 flex-col justify-end p-8">
              <p className="ornament text-sm">◆</p>
              <h2 className="serif mt-4 text-4xl font-semibold uppercase tracking-[0.08em]">FAQ</h2>
          ...
          {faqs.map((faq) => (
            <details key={faq.id} className="section-frame p-5">
              <summary className="cursor-pointer list-none">
                ...
                <h2 className="serif mt-1 text-2xl font-semibold">{faq.question}</h2>
              </summary>
