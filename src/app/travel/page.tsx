    ...
    <GuestPage>
      ...
      <section className="py-10">
        <div className="container">
          <div className="section-frame dark-panel relative mb-5 overflow-hidden p-10 text-center">
            ...
            <div className="relative">
              <h2 className="serif text-4xl font-semibold uppercase tracking-[0.08em]">Travel guide</h2>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {sections.map((section) => (
            <article key={section.id} className="section-frame p-6">
              <p className="text-[0.68rem] font-bold uppercase tracking-[0.18em] text-[#9b7039]">{section.category}</p>
              <h2 className="serif mt-2 text-3xl font-semibold uppercase tracking-[0.08em]">{section.title}</h2>
